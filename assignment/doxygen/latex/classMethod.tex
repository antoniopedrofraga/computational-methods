...
Default constructor. Intialize a \hyperlink{classMethod}{Method} object \begin{DoxySeeAlso}{See also}
...
Alternate constructor. Initializes a \hyperlink{classMethod}{Method} with a given parabolic problem. \begin{DoxySeeAlso}{See also}
\hyperlink{classMethod_ab48717dc68d3c057b65574a539a480f7}{Method()} 
\end{DoxySeeAlso}
...
Normal public method. Keeps track of the time to compute a solution \index{Method@{Method}!compute\+\_\+solution@{compute\+\_\+solution}}
...
Normal public get method. get the elapsed time value to compute a solution \begin{DoxyReturn}{Returns}
...
Normal public get method. get the time step of the solution \begin{DoxyReturn}{Returns}
...
Normal public get method. get the method name \begin{DoxyReturn}{Returns}
...
Normal public get method. get the solution grid \begin{DoxyReturn}{Returns}
...
Normal public get method. get the second norm \begin{DoxyReturn}{Returns}
...
Normal public get method. get x values vector \begin{DoxyReturn}{Returns}
...
Protected string name. Name of the method. \index{Method@{Method}!problem@{problem}}
...
Protected \hyperlink{classProblem}{Problem} problem. Space step of the solution. \index{Method@{Method}!q@{q}}
