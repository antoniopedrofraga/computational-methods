...
void IOManager::plot_laasonen_times() {
	...
	gp << "set tics scale 0; set border 3; set style line 1 lc rgb '#0060ad' lt 1 lw 2 pt 7 pi -1 ps 1.5; set clip two; set ylabel \"Computational Time [ms]\";set xlabel \"Delta t [h]\"; set term png; set xtics (\"0.01\" 0, \"0.025\" 1, \"0.05\" 2, \"0.1\" 3)\n";
...
void IOManager::plot_default_deltat_times() {
	...
	gp << "set tics scale 0; set border 3; set style line 1 lc rgb '#0060ad' lt 1 lw 2 pt 7 pi -1 ps 1.5; set clip two; set ylabel \"Computational Time [ms]\";set xlabel \"Delta t [h]\"; set term png; set xtics (\"Dufort-Frankel\" 0, \"Crank-Nicholson\" 1, \"Laasonen\" 2)\n";
